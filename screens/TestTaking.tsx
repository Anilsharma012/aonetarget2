      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-[#1A237E] to-[#303F9F] text-white py-4 px-4">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate('/mock-tests')} className="p-2 rounded-full hover:bg-white/20">
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-[#1A237E] text-white px-4 py-3 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <button onClick={() => setConfirmSubmit(true)} className="p-1.5 rounded-full hover:bg-white/20">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-gray-400">{currentQuestion.marks || 1} mark{(currentQuestion.marks || 1) > 1 ? 's' : ''}</span>
                <button
      ...
      <div className="bg-white border-t border-gray-200 px-4 py-3 flex items-center justify-between sticky bottom-0">
        <button
          ...
          className={`flex items-center gap-1 px-4 py-2.5 rounded-lg text-xs font-bold ${
            currentIndex === 0 ? 'text-gray-300 bg-gray-50' : 'text-[#303F9F] bg-blue-50'
          }`}
        >
