...
export type AdminView = 'dashboard' | 'misc' | 'students' | 'buyers' | 'tokens' | 'coupons' | 'store' | 'institute' | 'questions' | 'tests' | 'subjective-test' | 'test-series' | 'all-reports' | 'videos' | 'live-videos' | 'pdfs' | 'packages' | 'messages' | 'blog' | 'settings' | 'banners';
