      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-6 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-wider transition-all ${
            activeTab === 'all' ? 'bg-[#1A237E] text-white shadow-lg' : 'bg-white text-gray-500 border border-gray-200'
          }`}
        >
          All Referrals
        </button>
        <button
          ...
          className={`px-6 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-wider transition-all ${
            activeTab === 'settings' ? 'bg-[#1A237E] text-white shadow-lg' : 'bg-white text-gray-500 border border-gray-200'
          }`}
        >
          Commission Settings
        </button>
